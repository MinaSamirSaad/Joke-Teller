...
const tellMe=(src)=>{
    VoiceRSS.speech({
        key: '2574e5d6727f4c60af8484bd8af070e9',
        src: src,
        hl: 'en-us',
        v: 'Linda',
        r: 0, 
...
// Get joks from Joke API
const getJokes = async()=>{
    let joke = ''
    try{
        const respose = await fetch("https://v2.jokeapi.dev/joke/Any?blacklistFlags=nsfw,religious,political,racist,sexist,explicit");
